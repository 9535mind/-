...
**직접 업로드** 탭에서 이제 **파일 업로드**와 **URL 입력** 두 가지 방식을 모두 지원합니다!
...
**직접 업로드** 탭을 클릭하면 **두 가지 버튼**이 표시됩니다:
...
### Q1: YouTube URL도 입력할 수 있나요?

**아니요!** YouTube URL은 **"YouTube" 탭**을 사용하세요.

```
[YouTube 탭]     [직접 업로드 탭]
    ↓                  ↓
YouTube URL      api.video / 직접 영상 URL
```
...
|------|------------|----------|
| **사용 사례** | 로컬 파일 | 외부 URL |
| **소요 시간** | 파일 크기 따라 | api.video URL은 즉시 |
| **용량 제한** | 500MB | 제한 없음 (api.video 기준) |
| **일괄 업로드** | ✅ 지원 | 🔜 예정 |
| **드래그 앤 드롭** | ✅ 지원 | ❌ 미지원 |
