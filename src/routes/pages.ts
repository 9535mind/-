        ...
        <div class="max-w-2xl w-full space-y-8">
            ...
            <div id="registerMethodSelection" class="mt-8">
                <div class="space-y-3">
                    ...
                    <!-- 카카오로 계속하기 -->
                    <button onclick="registerWithKakao()" 
                        class="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#FEE500] border-2 border-[#FEE500] rounded-lg hover:bg-[#FDD835] transition-all shadow-sm">
                        <img src="https://developers.kakao.com/assets/img/about/logos/kakaolink/kakaolink_btn_small.png" 
                             alt="Kakao" class="w-6 h-6">
                        <span class="text-lg font-semibold text-gray-900">카카오로 계속하기</span>
                    </button>
                    
                    <!-- 전화번호로 시작하기 -->
                    <button onclick="selectRegisterMethod('phone')" 
                        class="w-full flex items-center justify-center gap-3 px-6 py-4 bg-green-500 border-2 border-green-500 rounded-lg hover:bg-green-600 transition-all shadow-sm">
                        <i class="fas fa-mobile-alt text-2xl text-white"></i>
                        <span class="text-lg font-semibold text-white">전화번호로 시작하기</span>
                    </button>
                </div>
                ...
                <div class="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <div class="flex items-start gap-2">
                        ...
                        <div class="text-sm text-gray-700">
                            <p class="font-semibold mb-1">💡 빠른 가입 팁</p>
                            <ul class="space-y-1 ml-4 list-disc">
                                <li><strong>소셜 로그인</strong>: Google 또는 카카오 계정으로 1초 만에 시작!</li>
                                <li><strong>전화번호</strong>: 이메일이 없어도 휴대폰 본인인증으로 바로 가입 가능!</li>
                                <li><strong>강의 신청 시</strong>: 추가 정보(전화번호)는 수강 신청할 때만 입력하면 됩니다.</li>
                            </ul>
                        </div>
                    </div>
                </div>
